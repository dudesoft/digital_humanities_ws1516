...
public class SampleAppMenuGroup {
   ...
   public SampleAppMenuGroup(SampleAppMenuInterface menuInterface, Activity context,
         SampleAppMenu parent, boolean hasTitle, String title, int width) {
      mActivity = context;
      ...
      mEntriesTextSize = mActivity.getResources()
            .getDimension(R.dimen.menu_entries_text);

      mEntriesSidesPadding = (int) mActivity.getResources()
            .getDimension(R.dimen.menu_entries_sides_padding);
      mEntriesUpDownPadding = (int) mActivity.getResources()
            .getDimension(R.dimen.menu_entries_top_down_padding);
      ...
      titleView.setTextSize(mActivity.getResources()
            .getDimension(R.dimen.menu_entries_title));
      ...
      mClickListener = new OnClickListener() {
         ...
         public void onClick(View v) {
            int command = Integer.parseInt(v.getTag()
                  .toString());
      ...
      mOnCheckedListener = new OnCheckedChangeListener() {
         ...
         public void onCheckedChanged(CompoundButton switchView, boolean isChecked) {
            boolean result;
            int command = Integer.parseInt(switchView.getTag()
                  .toString());
   ...
   public View addRadioItem(String text, int command, boolean isSelected) {
      ...
      Drawable selectorDrawable = mActivity.getResources()
            .getDrawable(selectorResource);

      RadioButton newRadioButton =
            (RadioButton) inflater.inflate(R.layout.sample_app_menu_group_radio_button, null,
                  false);
      ...
      newRadioButton.setPadding(mEntriesSidesPadding, mEntriesUpDownRadioPadding,
            mEntriesSidesPadding, mEntriesUpDownRadioPadding);
      ...
      // Set the listener after changing the UI state to avoid calling the radio button
      // functionality when creating the menu
   ...
   public View addSelectionItem(String text, int command, boolean on) {
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
         ...
         newSwitchView.setPadding(mEntriesSidesPadding, mEntriesUpDownPadding, mEntriesSidesPadding,
         ...
         newView.setPadding(mEntriesSidesPadding + leftPadding, mEntriesUpDownPadding,
   ...
   public View addTextItem(String text, int command) {
      ...
      newTextView.setPadding(mEntriesSidesPadding, mEntriesUpDownPadding, mEntriesSidesPadding,
            mEntriesUpDownPadding);
