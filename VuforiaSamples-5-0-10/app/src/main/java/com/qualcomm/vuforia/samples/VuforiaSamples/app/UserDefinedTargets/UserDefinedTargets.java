...
public class UserDefinedTargets extends Activity
            ...
            if (dataSetUserDef.getNumTrackables() > 0) {
               ...
               if (!mExtendedTracking) {
                  ...
                  if (!trackable.stopExtendedTracking()) {
                     ...
                     Log.d(LOGTAG, "Successfully stopped extended tracking target");
                  }
               }
            }
   ...
   public void onQCARUpdate(State state) {
      ...
      if (refFreeFrame.hasNewTrackableSource()) {
         ...
         if (dataSetUserDef.hasReachedTrackableLimit() || dataSetUserDef.getNumTrackables() >= 5) {
   ...
   public void showInitializationErrorMessage(String message) {
      ...
      runOnUiThread(new Runnable() {
         public void run() {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(UserDefinedTargets.this);
   ...
   void startBuild() {
      ...
      if (objectTracker != null) {
         ...
         if (targetBuilder != null) {
            ...
            //if (targetBuilder.getFrameQuality() == ImageTargetBuilder.FRAME_QUALITY
            // .FRAME_QUALITY_LOW)
            //{
   ...
   private void showErrorDialog() {
      ...
      mDialog.setButton(DialogInterface.BUTTON_POSITIVE, getString(R.string.button_OK),
            clickListener);
