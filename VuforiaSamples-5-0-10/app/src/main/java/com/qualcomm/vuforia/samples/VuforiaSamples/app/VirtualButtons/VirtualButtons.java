...
public class VirtualButtons extends Activity
   ...
   public boolean doLoadTrackersData() {
      ...
      // Load the data set:
      if (!dataSet.load("VirtualButtons/Wood.xml", STORAGE_TYPE.STORAGE_APPRESOURCE)) {
   ...
   public void onInitARDone(SampleApplicationException exception) {
      ...
      if (exception == null) {
         ...
         mSampleAppMenu =
               new SampleAppMenu(this, this, "Virtual Buttons", mGlView, mUILayout, null);
   ...
   public void onQCARUpdate(State state) {
      if (updateBtns) {
         ...
         if ((buttonMask & BUTTON_1) != 0) {
            ...
            toggleVirtualButton(imageTarget, virtualButtonColors[0], -108.68f, -53.52f, -75.75f,
                  -65.87f);
         }
         if ((buttonMask & BUTTON_2) != 0) {
            Log.d(LOGTAG, "Toggle Button 2");

            toggleVirtualButton(imageTarget, virtualButtonColors[1], -45.28f, -53.52f, -12.35f,
                  -65.87f);
         }
         if ((buttonMask & BUTTON_3) != 0) {
            Log.d(LOGTAG, "Toggle Button 3");

            toggleVirtualButton(imageTarget, virtualButtonColors[2], 14.82f, -53.52f, 47.75f,
                  -65.87f);
         }
         if ((buttonMask & BUTTON_4) != 0) {
            Log.d(LOGTAG, "Toggle Button 4");

            toggleVirtualButton(imageTarget, virtualButtonColors[3], 76.57f, -53.52f, 109.50f,
                  -65.87f);
         }
   ...
   boolean toggleVirtualButton(ImageTarget imageTarget, String name, float left, float top,
   ...
   private void loadTextures() {
      ...
      mTextures.add(
            Texture.loadTextureFromApk("VirtualButtons/TextureTeapotYellow.png", getAssets()));
      mTextures.add(
            Texture.loadTextureFromApk("VirtualButtons/TextureTeapotGreen.png", getAssets()));
   }
   ...
   private void setSampleAppMenuSettings() {
      ...
      group.addSelectionItem(getString(R.string.menu_button_red), CMD_BUTTON_RED, true);
      group.addSelectionItem(getString(R.string.menu_button_blue), CMD_BUTTON_BLUE, true);
      group.addSelectionItem(getString(R.string.menu_button_yellow), CMD_BUTTON_YELLOW, true);
      group.addSelectionItem(getString(R.string.menu_button_green), CMD_BUTTON_GREEN, true);
