...
public class SampleAppMenu {
   ...
   public SampleAppMenu(SampleAppMenuInterface menuInterface, Activity activity, String menuTitle,
         GLSurfaceView movableView, RelativeLayout parentView,
         ArrayList<View> additionalViewsToHide) {
      ...
      mParentMenuView =
            (SampleAppMenuView) inflater.inflate(R.layout.sample_app_menu_layer, null, false);
      ...
      vto.addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
         ...
         public void onGlobalLayout() {
            ...
            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(mListViewWidth,
            ...
            LinearLayout.LayoutParams groupParams = new LinearLayout.LayoutParams(mListViewWidth,
   ...
   public SampleAppMenuGroup addGroup(String string, boolean hasTitle) {
      SampleAppMenuGroup newGroup =
            new SampleAppMenuGroup(mMenuInterface, mActivity, this, hasTitle, string, 700);
   ...
   public boolean processEvent(MotionEvent event) {
      ...
      if (event.getAction() == MotionEvent.ACTION_UP && !result) {
         ...
         if (!isMenuDisplaying() ||
            ...
            if (isMenuDisplaying() || getViewX(mMovableView) <
                  (mScreenWidth * SETTINGS_MENU_SCREEN_MIN_PERCENTAGE_TO_SHOW)) {
               hideMenu();
            } else {
               showMenu();
            }
