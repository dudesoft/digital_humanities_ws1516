...
public class CylinderTargets extends Activity
   ...
   public boolean doLoadTrackersData() {
      ...
      if (!dataSet.load("CylinderTargets/sodacan.xml", STORAGE_TYPE.STORAGE_APPRESOURCE)) {
         return false;
      }
   ...
   public boolean doUnloadTrackersData() {
      ...
      if (dataSet != null && dataSet.isActive()) {
         if (objectTracker.getActiveDataSet()
               .equals(dataSet) && !objectTracker.deactivateDataSet(dataSet)) {
            result = false;
   ...
   public void onInitARDone(SampleApplicationException exception) {
      ...
      if (exception == null) {
         ...
         mSampleAppMenu =
               new SampleAppMenu(this, this, "Cylinder Targets", mGlView, mUILayout, null);
   ...
   public void showInitializationErrorMessage(String message) {
      ...
      runOnUiThread(new Runnable() {
         public void run() {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(CylinderTargets.this);
   ...
   private void loadTextures() {
      mTextures.add(Texture.loadTextureFromApk("CylinderTargets/TextureWireframeNoBorder.png",
            getAssets()));
