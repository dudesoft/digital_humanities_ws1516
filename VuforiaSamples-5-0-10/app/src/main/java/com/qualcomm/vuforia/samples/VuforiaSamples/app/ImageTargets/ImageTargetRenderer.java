...
public class ImageTargetRenderer implements GLSurfaceView.Renderer {
   ...
   private void initRendering() {
      ...
      try {
         ...
         mBuildingsModel.loadModel(mActivity.getResources()
               .getAssets(), "ImageTargets/Buildings.txt");
      } catch (IOException e) {
   ...
   private void renderFrame() {
      ...
      for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
         ...
         int textureIndex = trackable.getName()
               .equalsIgnoreCase("stones") ? 0 : 1;
         textureIndex = trackable.getName()
               .equalsIgnoreCase("tarmac") ? 2 : textureIndex;
         ...
         if (!mActivity.isExtendedTrackingActive()) {
            ...
            GLES20.glVertexAttribPointer(vertexHandle, 3, GLES20.GL_FLOAT, false, 0,
                  mBuildingsModel.getVertices());
            GLES20.glVertexAttribPointer(normalHandle, 3, GLES20.GL_FLOAT, false, 0,
                  mBuildingsModel.getNormals());
            GLES20.glVertexAttribPointer(textureCoordHandle, 2, GLES20.GL_FLOAT, false, 0,
