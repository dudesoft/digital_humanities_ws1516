...
public class ObjectTargetRenderer implements GLSurfaceView.Renderer {
   ...
   private void renderFrame() {
      ...
      for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
         ...
         float[] objectSize = objectTarget.getSize()
               .getData();
         ...
         // finally render
         GLES20.glDrawElements(GLES20.GL_TRIANGLES, mCubeObject.getNumObjectIndex(),
               GLES20.GL_UNSIGNED_SHORT, mCubeObject.getIndices());
