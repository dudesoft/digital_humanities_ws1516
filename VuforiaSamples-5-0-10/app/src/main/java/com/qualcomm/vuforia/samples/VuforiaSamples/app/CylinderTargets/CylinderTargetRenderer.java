...
public class CylinderTargetRenderer implements GLSurfaceView.Renderer {
   ...
   private float kCylinderTopRadiusRatio = kCylinderTopDiameter / kCylinderBottomDiameter;
   ...
   private float kObjectScale = kCylinderHeight / (kRatioCylinderObjectHeight * kObjectHeight);
   ...
   private void initRendering() {
      ...
      try {
         ...
         mSphereModel.loadModel(mActivity.getResources()
               .getAssets(), "CylinderTargets/Sphere.txt");
      } catch (IOException e) {
   ...
   private void renderFrame() {
      ...
      for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
         ...
         GLES20.glDrawElements(GLES20.GL_TRIANGLES, mCylinderModel.getNumObjectIndex(),
         ...
         GLES20.glVertexAttribPointer(vertexHandle, 3, GLES20.GL_FLOAT, false, 0,
               mSphereModel.getVertices());
         GLES20.glVertexAttribPointer(normalHandle, 3, GLES20.GL_FLOAT, false, 0,
               mSphereModel.getNormals());
         GLES20.glVertexAttribPointer(textureCoordHandle, 2, GLES20.GL_FLOAT, false, 0,
               mSphereModel.getTexCoords());
